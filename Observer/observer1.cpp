...
struct PersonListener
{
  ...
  virtual void person_changed(Person& p, const string& property_name, const auto new_value) = 0;
};
...
struct Person
{
  ...
  void notify(const string& property_name, const auto new_value);
private:
  int age;
...
void Person::notify(const string& property_name, const auto new_value)
{
...
{
  void person_changed(Person& p, const string& property_name, const auto new_value) override
  {
