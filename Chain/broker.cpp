...
class Creature
{
        ...
        int GetAttack() const
        {
                ...
                game.queries(q); // call all connected signal function.
                return q.result;
        }
...
class DoubleAttackModifier : public CreatureModifier
{
                ...
                : CreatureModifier(game, creature)
        {
                ...
                conn = game.queries.connect([&](Query& q) //reference all ref val outside.
        ...
        {
                conn.disconnect(); //disconnect from signal
        }
};
